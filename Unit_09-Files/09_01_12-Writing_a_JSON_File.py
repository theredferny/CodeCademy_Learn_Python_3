...
had a Python dictionary we wanted to save as a JSON file:
...
method to write to the file. json.dump() takes two arguments: first the data object, then the file object you want to
save. """
