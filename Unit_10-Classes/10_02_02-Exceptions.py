...
issubclass() returns True if the first argument is a subclass
...
class OutOfStock(Exception):  # class SubClassName(ClassName):
    """
    Exception that gets thrown when the candles are out of stock
    """
