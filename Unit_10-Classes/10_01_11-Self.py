"""
Since we can already use dictionaries to store key-value pairs,
using objects for that purpose is not really useful.
...
using the arguments passed in to it. If we were creating a search engine,
and we wanted to create classes for each separate entry we could return.
...
We can write our classes to structure the data that we need and write methods that will interact
